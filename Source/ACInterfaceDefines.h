...
#define BOTTOM_PANEL_WIDTH     200
#define BOTTOM_PANEL_HEIGHT   100

#define BOTTOM_RIGHT_PANEL_WIDTH   200
#define BOTTOM_RIGHT_PANEL_HEIGHT  100
...
const Colour ACColour_8 = Colours::skyblue;
