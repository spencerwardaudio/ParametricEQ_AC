/*
  ==============================================================================
    ...
    ACAnalyzer.h
    Created: 23 Jun 2020 12:15:38pm
    Author:  Spencer Ward
...
class ACAnalyzer : public Thread
{
public:
    ACAnalyzer() : Thread ("ACAnalyzer")
    {
        averager.clear();
    }

    virtual ~ACAnalyzer() = default;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ACAnalyzer)
};
